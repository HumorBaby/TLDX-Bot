...
setup(
    name='sopel_modules.tldx_bot',
    version='0.1.0',
    description="Automatic summaries of various media for humans who don't want to (or can't) click links in IRC chats.",
    long_description=readme + '\n\n' + history,
    author='Humorous Baby',
    author_email='44451911+HumorBaby@users.noreply.github.com',
    url='https://github.com/HumorBaby/TLDX-Bot',
